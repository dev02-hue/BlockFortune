...
const AboutUs = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between gap-8 px-6 md:px-12 py-12 max-w-7xl mx-auto mt-10">
      ...
      >
        ...
        <p className="text-gray-600 text-base leading-relaxed">
          Welcome to BlockFortune Investment Platform, your premier
          gateway to diversified investment opportunities. At BlockFortune, we are committed to maximizing your wealth through strategic
          investments in four dynamic sectors: real estate, agriculture, crypto
          mining, and stock trading.
        </p>

        <p className="text-gray-600 text-base leading-relaxed">
          BlockFortune was founded with a vision to empower
      ...
      >
        <div className="rounded-2xl overflow-hidden shadow-lg">
          <Image
            src="/philip-strong-iOBTE2xsYko-unsplash.jpg" // Replace with actual path or import
            alt="About Accilent"
            width={600}
            height={400}
